...
#define VERSION_S "Gen_Seq version 1.01"
...
typedef struct GENSEQ
{
	...
	struct IN_CONS *cons;/*	Constraint settings object */
	...
	char filtname[NSIZE];/*	Filename of seqs to filter */
	FILE *filt;			/*	File of seqs to filter */
	int fform;			/*	Filter file format */
    int iraw, ifas;     /* Filter input format flags */
