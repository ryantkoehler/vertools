...
char CompDNABaseC(char c)
{
	switch(c)
	{
        ...
        */
		...
		case '[': 	return(']');
		case ']': 	return('[');
		case 'S': 	return('S');    /* S = [C/G] => [G/C] = S */
		case 's': 	return('s');
		case 'W': 	return('W');    /* W = [A/T] => [T/A] = W */
		case 'w': 	return('w');
		case 'M': 	return('K');    /* M = [A/C] => [T/G] = K */
		case 'm': 	return('k');
		case 'K': 	return('M');    /* K = [G/T] => [C/A] = M */
		case 'k': 	return('m');
		case 'R': 	return('Y');    /* R = [A/G] => [T/C] = Y */
		case 'r': 	return('y');
		case 'Y': 	return('R');    /* Y = [C/T] => [G/A] = R */
		case 'y': 	return('r');
        /***
        *   Triple degenerate 
        */
		case 'B': 	return('V');    /* B = [C/G/T] => [G/C/A] = V */
		case 'b': 	return('v');
		case 'D': 	return('H');    /* D = [A/G/T] => [T/C/A] = H */
		case 'd': 	return('h');    
		case 'H': 	return('D');    /* H = [T/C/A] => [A/G/T] = D */
		case 'h': 	return('d');    
		case 'V': 	return('B');    /* V = [A/C/G] => [T/G/C] = B */
		case 'v': 	return('b');    
		default: 	return(c);
	}
}
