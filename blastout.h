...
#define VERSION_S	"BlastOut version 0.61"

#define BLASTOUT_ID	5031
#define BLASTANS_ID	6005

#define BLBSIZE		300		/* Blastout buff size */
...
typedef struct BLASTOUT
{
	...
	char nsqh[NSIZE];       /* Name output seqs query + XXX + hit */
...
#define DEF_MAXHITS	2500	/* Def max hits / record */
