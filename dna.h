...
#define SEQFM_FASTA     82  /* Fasta format; > on one line, followed by seq */
#define SEQFM_NFAS      83  /* "nice" Fasta format (seq wrapped) */
#define SEQFM_SEQ       84  /* Only sequence; No name */
...
#define SEQ_NAME_S      "Sequence-%d\n" /* seq name format string */
